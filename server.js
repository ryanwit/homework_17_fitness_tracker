...
mongoose.connect(process.env.MONGODB_URI || "mongodb://localhost/fitnessWorkout", { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true, useFindModify: false});
